 ...
 * simulate-attack.js
 *
 * Demonstrates the full Stasis defense by triggering a real oracle price drop.
 *
 ...
 *   2. Invoke Stasis._onEvent() in the same block — automatically
 *   3. Stasis's risk engine checks threshold → pool.pause() if ≥20%
 *
...
async function main() {
  ...
  if (!oracleAddress || !stasisAddress || !poolAddress) {
    throw new Error("Missing contract addresses in .env. Run deploy.js first.");
  }

  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log("⚔️  Stasis — Flash Loan Attack Simulation");
  ...
  console.log("   Subscription ID:", stasis.subscriptionId ? await stasis.subscriptionId() : "check contract");
  console.log();
  ...
  console.log("⏳ Waiting for Somnia validators to auto-invoke Stasis._onEvent()...");
